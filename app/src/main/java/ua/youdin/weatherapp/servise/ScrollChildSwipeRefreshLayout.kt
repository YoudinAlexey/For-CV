...
fun Fragment.setupRefreshLayout(
    ...
    refreshLayout.setColorSchemeColors(
        ContextCompat.getColor(requireActivity(), R.color.gray_920),
        ContextCompat.getColor(requireActivity(), R.color.yelow_200),
        ContextCompat.getColor(requireActivity(), R.color.yelow_500)
    )
